...
int main(int argc, char *argv[])
{
   ...
   TH2D HWorld("HWorld", ";Jet |#eta|;Simulated jet response", 100, 0, 4.8, 100, 0.32, 1.29);
   ...
   Latex.DrawLatex(0.607, 0.72, "EC2");
   Latex.DrawLatex(0.79, 0.72, "HF");

   Latex.SetTextSize(0.045);
   Latex.DrawLatex(0.55, 0.85, Form("#font[62]{%s JES: Anti-k_{T} R = 0.4, PF + CHS}", Year.c_str()));
