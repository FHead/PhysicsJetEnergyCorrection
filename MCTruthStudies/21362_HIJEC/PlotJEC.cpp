...
int main(int argc, char *argv[])
{
   ...
   DefaultRho = 10;
   PlotEtaDependence(PdfFile,  10, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 10,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile,  30, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 30,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile,  50, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 50,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile,  70, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 70,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile, 100, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 100, rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile, 150, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 150, rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile, 200, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 200, rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile, 250, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 250, rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile, 500, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 500, rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   DefaultRho = 30;
   PlotEtaDependence(PdfFile,  10, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 10,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile,  30, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 30,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
   PlotEtaDependence(PdfFile,  50, DefaultRho, JECL1, JECL2L3, Labels, Form("p_{T}^{reco} = 50,  rho = %.1f;#eta", DefaultRho), 1000, -5, 5, OffsetMode);
