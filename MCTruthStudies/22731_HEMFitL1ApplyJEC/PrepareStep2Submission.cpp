...
int main(int argc, char *argv[])
{
   ...
   cout << "echo \"requirements = (OpSysAndVer =?= \\\"CentOS7\\\")\" >> $SubmissionFile" << endl;
   // cout << "echo \"transfer_output_files = DONE.txt\" >> $SubmissionFile" << endl;
   cout << "echo \"+JobFlavour = \"longlunch\"\" >> $SubmissionFile" << endl;
