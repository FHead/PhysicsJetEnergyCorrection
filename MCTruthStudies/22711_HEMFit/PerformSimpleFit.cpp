...
string GetFunction(string Phi, double PTMin);
...
int main(int argc, char *argv[])
{
   ...
   string Function = GetFunction("t", PTMin);
...
vector<double> FitClass::HEMDoFit(bool FixOutside, double FixP0, double FixP1, double FixP2)
{
   ...
   Worker->SetLimitedVariable(3, "HEMP0", 0.0, 0.1, -1000, 1000);
   Worker->SetLimitedVariable(4, "HEMP1", 1.0, 0.1, -1000, 1000);
   Worker->SetLimitedVariable(5, "HEMP2", 1.0, 0.1, -1000, 1000);
   Worker->SetLimitedVariable(6, "HEMP3", -2e-3, 0.1, -1000, 1000);
...
string GetFunction(string Phi, double PTMin)
{
   ...
   string FIn  = Form("([3]+[4]*x+[5]*log(max(%.1f,y)/15)+[6]*log(max(%.1f,y)/15)*log(max(%.1f,y)/15))", PTMin, PTMin, PTMin);
