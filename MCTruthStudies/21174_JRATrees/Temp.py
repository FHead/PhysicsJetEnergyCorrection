...
process.GlobalTag.globaltag = cms.string('102X_upgrade2018_realistic_v12HEfail_v3')
...
try:
    ...
    inputFiles = cms.untracked.vstring(
      "file:InputTrees/FlatPU//Run52/JME-RunIIAutumn18DR-00003.root"
	    )
